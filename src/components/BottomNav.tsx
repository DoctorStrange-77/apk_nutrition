...
const items: Array<{ id: Tab; label: string; icon: JSX.Element }> = [
  ...
  },
  {
    id: 'diary',
    label: 'Diario',
    icon: <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3h12v18H6z"/><path d="M9 7h6M9 11h6M9 15h4"/><path d="M4 6h2M4 10h2M4 14h2M4 18h2"/></svg>,
  },
  {
    id: 'smart',
    label: 'Smart',
  ...
  },
  {
    id: 'progress',
    label: 'Progressi',
    icon: <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 19V5"/><path d="M4 19h16"/><path d="m7 15 4-4 3 2 5-6"/><path d="M16 7h3v3"/></svg>,
  },
  {
    id: 'profile',
    label: 'Profilo',
