  ...
  return (
    ...
    >
      ...
      <div className="replacement-intro">
        ...
        <p>Le proposte sono ordinate per somiglianza nutrizionale. Dopo la scelta, Smart Nutrition riottimizza le grammature del pasto per restare il più vicino possibile al target.</p>
      </div>
