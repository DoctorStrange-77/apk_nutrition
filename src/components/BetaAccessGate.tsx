...
export function BetaAccessGate({ children }: Props) {
  ...
  if (gateState === 'checking') {
    return <div className="beta-screen"><div className="beta-card beta-loading"><div className="beta-logo">S</div><h1>Smart Nutrition</h1><p>Verifica accesso in corso…</p><div className="beta-spinner" /></div></div>;
  }

  if (gateState === 'signed_out') {
    return <div className="beta-screen"><form className="beta-card" onSubmit={login}>
      <div className="beta-logo">S</div>
      ...
      <small className="beta-version">Smart Nutrition 1.3.0 Beta</small>
    </form></div>;
  }
